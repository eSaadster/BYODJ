...
- Transport buttons: "Play Sequence", "Stop Sequence", "Clear Grid", "Randomize Grid", "Clear All", "Export MIDI" (downloads the current arrangement as a .mid file - only click when asked). Clear and Randomize act on the CURRENT scene only; Clear All wipes all four scenes, the chain and the song and returns to loop mode on scene A (sound design and mixer are kept).
